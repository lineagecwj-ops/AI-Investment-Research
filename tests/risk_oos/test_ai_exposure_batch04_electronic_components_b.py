...
ARTIFACT_PATH = (
    ...
    / "technical_risk_ai_exposure_batch04_electronic_components_b_v1.json"
)
PHASE1_MAPPING_PATH = (
    PROJECT_ROOT
    / "data"
...
class TechnicalRiskAIExposureBatch04ElectronicComponentsBTestCase(unittest.TestCase):
    def setUp(self):
    ...
    def test_artifact_contains_exact_batch_membership(self):
        self.assertEqual(self.artifact["batch_id"], "ELECTRONIC_COMPONENTS_B_BATCH_04")
    ...
    def test_artifact_checksum_and_id_are_deterministic(self):
        ...
        self.assertEqual(
            ...
            f"technical_risk_ai_exposure_batch04_electronic_components_b_{checksum[:16]}",
        )
