...
ARTIFACT_PATH = (
    ...
    / "technical_risk_ai_exposure_batch02_semiconductor_b_v1.json"
)
PHASE1_MAPPING_PATH = (
    PROJECT_ROOT
    / "data"
...
class TechnicalRiskAIExposureBatch02SemiconductorBTestCase(unittest.TestCase):
    def setUp(self):
    ...
    def test_artifact_contains_exact_batch_membership(self):
        self.assertEqual(self.artifact["batch_id"], "SEMICONDUCTOR_B_BATCH_02")
    ...
    def test_artifact_checksum_and_id_are_deterministic(self):
        ...
        self.assertEqual(
            ...
            f"technical_risk_ai_exposure_batch02_semiconductor_b_{checksum[:16]}",
        )
